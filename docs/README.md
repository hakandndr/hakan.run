...
| [GITHUB-CI.md](./GITHUB-CI.md) | Repository, Playwright workflow, coverage, and version drift |
| [HISTORY.md](./HISTORY.md) | Git-supported project history and explicitly qualified context |
