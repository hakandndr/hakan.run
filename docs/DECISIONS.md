...
- Status: Scroll, first-entry presentation and blank React LOADING behavior are deployed to staging from `7f506e3`; deletion of the pre-React static shell is focused-validated locally, uncommitted and undeployed.
