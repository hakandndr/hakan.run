                ...
                {contact.infoBlocks.map((block) => (
                  <div key={block.title}>
                    ...
                    {block.lines.map((line, index) => (
                      <p key={index} className="text-[15px] text-gray-400">
              ...
              <div className="border border-white/10 rounded-xl overflow-hidden" style={{ backgroundColor: '#1A1A1A' }}>
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-5">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div>
                      <label htmlFor="contact-name" className="block font-mono text-[10px] text-accent-purple/70 uppercase tracking-widest mb-1.5">--name</label>
                      <input
                        id="contact-name"
                        type="text"
                        name="name"
                        ...
                        className="w-full border border-white/[0.08] rounded px-4 py-3 font-mono text-sm text-white placeholder-gray-700 focus:outline-none focus:border-accent-purple/50 focus:ring-1 focus:ring-accent-purple/30 transition-all duration-200"
                        style={{ backgroundColor: '#0D0D0D' }}
                      />
                    </div>
                    <div>
                      <label htmlFor="contact-email" className="block font-mono text-[10px] text-accent-purple/70 uppercase tracking-widest mb-1.5">--email</label>
                      <input
                        id="contact-email"
                        type="email"
                        name="email"
                  ...
                  <div>
                    <label htmlFor="contact-message" className="block font-mono text-[10px] text-accent-purple/70 uppercase tracking-widest mb-1.5">--message</label>
                    <textarea
                      id="contact-message"
                      name="message"
                      required
                      ...
                      className="w-full border border-white/[0.08] rounded px-4 py-3 font-mono text-sm text-white placeholder-gray-700 focus:outline-none focus:border-accent-purple/50 focus:ring-1 focus:ring-accent-purple/30 transition-all duration-200 resize-none"
                      style={{ backgroundColor: '#0D0D0D' }}
                    />
                  </div>
